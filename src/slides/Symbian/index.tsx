        ...
        <div className={classNames.content}>
          <section className={classNames.copyContainer}>
            <div className={classNames.copy}>
              ...
              <p className="mb-3">
                My work involved building the User Interfaces for Symbian's intranet tools, including their HR systems
                and software engineering microsites. I was also responsible for architecting and builing the front end
                for their Content Management System which was developed in collaboration with PA Systems.
              </p>
              <p>
                Notable successes include the launch of OneSymbian (a multi-million pound internal CMS that ran on IBM
                Websphere), and the internal Corporate Directory system which was used by all employees to manage their
                HR information.
              </p>
            </div>
          </section>
