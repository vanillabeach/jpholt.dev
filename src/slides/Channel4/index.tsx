        ...
        <section className={classNames.copyContainer}>
          <div className={classNames.copy}>
            ...
            <p className="mb-3">
              ...
              consisted of a series of microsites. My work involved creating image and media assets, working extensively
              with "plain" JavaScript application code, and working with multiple content management systems.
            </p>
            <p>
