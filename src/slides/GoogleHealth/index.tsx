        ...
        <section className={classNames.copyContainer}>
          <div className={classNames.copy}>
            ...
            <p>
              ...
              based on the "Health Material" design language conceived by our Design team. Around this time, I was also
              seconded to the{' '}
              <a
                className={classNames.link}
                rel="noreferrer"
              ...
              to help build hospital dashboards outlining the spread of CoVid during the pandemic. I was given an award
              by Google for my contribution.
            </p>
          </div>
        </section>
